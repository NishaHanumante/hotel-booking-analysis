...
-- 2.	List cars with prices higher than the average price of cars with the fuel type = 'Gasoline'.
-- 3.	List cars with prices higher than the average price of cars manufactured in the year 2021.
